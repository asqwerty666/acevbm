      ...
      do
        ...
        if [[ $DOQSUB -eq 1 ]];
          ...
          then
            ...
            id=`sbatch --job-name=antsrigid --export=ANTSPATH=$ANTSPATH $QSUBOPTS --time=${WALLTIME} $qscript | rev | cut -f1 -d\ | rev`
            jobIDs="$jobIDs $id"
            sleep 0.5
        elif [[ $DOQSUB -eq 0 ]];
          then
      ...
      do
        ...
        if [[ $DOQSUB -eq 1 ]];
          ...
          then
            ...
            id=`sbatch --job-name=antsdef${i} --export=ANTSPATH=$ANTSPATH --time=${WALLTIME} $QSUBOPTS $qscript | rev | cut -f1 -d\ | rev`
            jobIDs="$jobIDs $id"
            sleep 0.5
        elif [[ $DOQSUB -eq 0 ]];
          then
